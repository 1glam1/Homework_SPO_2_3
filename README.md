# Домашнее задание по Системному программному обеспечению (СПО) №2, 3
## Автор
...
Также в программе присутствует логирование. 
Благодаря этому мы сможем отслеживать действия в логах Docker Desktop или на хостинге(в моем случае в Amvera cloud).
